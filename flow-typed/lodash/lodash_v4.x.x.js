    type __CurriedFunction1<A, R, AA: A> = (...r: [AA]) => R;
    type CurriedFunction1<A, R> = __CurriedFunction1<A, R, *>;
  
    type __CurriedFunction2<A, B, R, AA: A, BB: B> = ((
      ...r: [AA]
    ) => CurriedFunction1<BB, R>) &
      ((...r: [AA, BB]) => R);
    type CurriedFunction2<A, B, R> = __CurriedFunction2<A, B, R, *, *>;
  
    type __CurriedFunction3<A, B, C, R, AA: A, BB: B, CC: C> = ((
      ...r: [AA]
    ...
    type Curry = (<A, R>((...r: [A]) => R) => CurriedFunction1<A, R>) &
    ...
    type matchesIterateeShorthand = Object;
    ...
    type _ValueOnlyIteratee<T> = (value: T) => mixed;
