...
export type Creep = {
     ...
     * @return {number|OK|ERR_NOT_OWNER|ERR_BUSY|ERR_INVALID_TARGET|ERR_NOT_IN_RANGE|ERR_NO_BODYPART}
     */
    attackController: (target: string) => int,
     ...
     */
    cancelOrder: (methodName: string) => int,
     ...
     */
    claimController: (target: string) => int,
     ...
     */
    notifyWhenAttacked: (enabled: bool) => number,
     ...
     * @return {number|OK|ERR_NOT_OWNER|ERR_BUSY|ERR_INVALID_TARGET|ERR_NOT_IN_RANGE|ERR_NO_BODYPART}
     */
    rangedAttack: (target: string) => int,
     ...
     * @return {number|OK|ERR_NOT_OWNER|ERR_BUSY|ERR_INVALID_TARGET|ERR_NOT_IN_RANGE|ERR_NO_BODYPART}
     */
    reserveController: (target: string) => int,
     ...
     */
    say: (message: string, is_public: boolean) => number,
     ...
     * @return {number|OK|ERR_NOT_OWNER|ERR_BUSY|ERR_NOT_ENOUGH_RESOURCES|ERR_INVALID_TARGET|ERR_NOT_IN_RANGE|ERR_NO_BODYPART}
     */
    upgradeController: (target: string) => int,
