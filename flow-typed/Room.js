...
export type Room = {
     ...
     */
    createFlag: (x: number, y: number & string, name: string, color: string, secondaryColor: string) => number,
     ...
     */
    lookForAtArea: (type: string, top: number, left: number, bottom: number, right:number, asArray: {}) => {},
};
